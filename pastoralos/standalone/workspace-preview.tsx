...
state.people=state.people.map((p,i)=>({...p,sample:false,assimilation:i>=3&&p.stage!=='Regular attendee',contactPermissions:{email:true,sms:true},stage:i<3?'Contact':p.stage,groups:i<4?['weekly']:['volunteers'],tags:i===0?['Volunteer']:[],groupPreferences:{weekly:{email:true,sms:false},volunteers:{email:false,sms:true}}}));
